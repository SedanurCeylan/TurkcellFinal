                    ...
                    <div className="col-md-3">
                        <div className="rounded-4 px-4">
                            ...
                            <ul className="list-group list-group-flush gap-3 fw-bold">
                                <li className="list-group-item border-0 ps-4 bg-primary rounded-5 text-white"><i className="fa-regular fa-user fs-3"></i>    {t('user_profile')}</li>
                                <li className="list-group-item border-0 ps-4"><i className="fa-regular fa-object-ungroup text-primary fs-3"></i>    {t('referrals')}</li>
                                <li className="list-group-item border-0 ps-4"><i className="fa-regular fa-life-ring text-primary fs-3"></i>    {t('api_keys')}</li>
                                <li className="list-group-item border-0 ps-4"><i className="fa-solid fa-clock-rotate-left text-primary fs-3"></i>   {t('login_history')}</li>
                                <li className="list-group-item border-0 ps-4"><i className="fa-solid fa-barcode text-primary fs-3"></i>    {t('two_fa')}</li>
                                <li className="list-group-item border-0 ps-4"><i className="fa-solid fa-unlock-keyhole text-primary fs-3"></i>    {t('change_password')}</li>
                            </ul>
                        </div>
                    </div>
                            ...
                            >
                                <Form className="row g-3">
                                    ...
                                    <div className="col-12">
                                        <button type="submit" className="btn btn-primary rounded-5 py-2 px-3 text-white mt-3">{t('change_password')}</button>
